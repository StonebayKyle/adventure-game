...
public class LookAtMouse : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Vector3 lookDir = cam.ScreenToWorldPoint(Input.mousePosition) - transform.position; // math done in world coordinates. Pixel coordinates are also possible, as long as it's consistent.
